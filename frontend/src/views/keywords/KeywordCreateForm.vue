<template>
  <form @submit.prevent="handleSubmit" class="keyword-create-form">
    <div class="grid">
      <div class="col-12">
        <div class="field">
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await keywordsStore.createKeyword(data)
    ...
    if (error.response?.data?.errors) {
      ...
      toast.add({
        severity: 'error',
        summary: 'Erreur',
        detail: error.response?.data?.message || 'Erreur lors de la création du mot-clé',
        life: 3000
      })
    }
  } finally {
